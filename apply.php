    ...
    <form action="process_eoi.php" method="POST" novalidate="novalidate">
        <fieldset>
            ...
            <p><label for="gname">Given Name*</label>
                <input type="text" name="gname" id="gname" maxlength="15" size="10" pattern="^[a-zA-Z ]+$">
            </p>
            ...
            <p><label for="fname">Family Name*</label>
                <input type="text" name="fname" id="fname" maxlength="15" size="10" pattern="^[a-zA-Z ]+$">
            </p>
            <p><label for="date">Date of Birth*</label>
                <input type="date" name="date" id="date" placeholder="dd/mm/yyyy" maxlength="10" size="10"
            ...
            <p><label for="street">Street Address*</label>
                <input type="text" name="street" id="street" maxlength="40" size="40">
            </p>
            ...
            <p><label for="postcode">Postcode*</label>
                <input type="text" name="postcode" id="postcode" maxlength="4" size="5" pattern="[0-9]{4,4}">
            </p>
        </fieldset>
        ...
        <fieldset>
            ...
            <p><label for="ref">Job Reference Number*</label>
                <input type="text" name="ref" id="ref" maxlength="5" size="7" pattern="[a-zA-Z0-9]+">
            </p>
        </fieldset>
        ...
        <fieldset>
            ...
            <p><label for="mobile">Mobile Number*</label>
                <input type="tel" name="mobile" id="mobile" maxlength="12" size="10" pattern="[0-9]{8,12}">
            </p>
            <p><label for="home">Home Number</label>
                <input type="tel" name="home" id="home" maxlength="12" size="10" pattern="[0-9]{10,10}">
            </p>
        ...
        <fieldset>
            ...
            <p><textarea id="exp" name="exp" rows="5" cols="50" required="required"
                    placeholder="Write a brief summary of previous experiences and/or qualifications/certificates..."></textarea>
            </p>
        </fieldset>
