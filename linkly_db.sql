...
INSERT INTO `about` 
(`member_id`, `member_name`, `student_id`, `dream_job`, `quote`, `snack`, `hometown`, `contributions`) VALUES 
(NULL, 'Ciara Smith', '106510563', 'Prime Minister', '\"Krigets högsta konst är att kuva fienden utan att strida\"\r\n(The supreme art of war is to subdue the enemy without fighting.)', 'Cookies', 'Yarrawonga', 'apply.php, process_eoi.php, search.php. eoi, about, jobs tables, tasks 1,3,4,5,7'), 
